...
#   timestamp: 2025-06-28T14:55:32+00:00
...
class CertificateParameters(BaseModel):
    DEGREE: str = Field(
        ...
        examples=[
            'BACHELOR OF ENGINEERING,BACHELOR OF COMPUTER APPLICATIONS,BACHELOR OF JOURNALISM,BACHELOR OF BUSINES'
        ],
    )
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    RROLL: str = Field(..., description='Roll No.', examples=['I086010055'])
